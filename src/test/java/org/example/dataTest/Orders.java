...
public class Orders {
    ...
    public static final Order createOrder = new Order(4, 3, 5, LocalDate.parse("2024-10-10"), "successfully");
    public static final Order filterOrder = new Order(1, 4, 1, LocalDate.parse("2024-08-12"), "заказ оформлен");
    public static final Order orderById = new Order(1, 4, 1, LocalDate.parse("2024-08-12"), "заказ оформлен");
